...
- [Payments](#3-payments)
	...
	- [Getting All Payments](#32-getting-all-payment)
- [Fiat Payments](#4-fiat-payments)
	- [Creating Fiat Payment](#43-creating-fiat-payment)
	- [Sending Invoice for Payment](#43-sending-invoice-for-payment)
	- [Getting Invoice Template for Payment](#44-getting-invoice-template-for-payment)
	- [Getting Receipt Template for Payment](#45-getting-receipt-template-for-payment)
